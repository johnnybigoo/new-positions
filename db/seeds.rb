# user = User.create!(email: 'company2@gmail.com', password: '123456', password_confirmation: '123456')

# company = Company.create!(name: 'Company Tech', url: 'https://google.com', user_id: user.id)
# company.logo.attach(io: File.open("#{Rails.root}/spec/fixtures/images/tech-logo.jpg"), filename: 'tech-logo.jpg')
